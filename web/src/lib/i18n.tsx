...
const EN: Record<string, string> = {
  ...
  // full-box pricing
  "{b} caixa(s) com {u} unidades": "{b} box(es) of {u} units",
  "{n} unidades adicionais": "{n} extra units",
  "Caixa fechada": "Full box",
  "por caixa de {n} unidades": "per box of {n} units",
  "Economize {v} por caixa": "Save {v} per box",
  "Comprar caixa completa": "Buy a full box",
  "Faltam {n} unidades para completar uma caixa.": "{n} more units to complete a box.",
  "vendido em caixas de {n}": "sold in boxes of {n}",
  "Ativar preço de caixa": "Enable box price",
  "Cada caixa completa é cobrada pelo preço da caixa; unidades avulsas usam o preço unitário do nível do carrinho.": "Each full box is charged at the box price; loose units use the cart-tier unit price.",
  "Preço da caixa (R$)": "Box price (R$)",
  "Só vender em caixas completas": "Sell in full boxes only",
  // admin price levels
